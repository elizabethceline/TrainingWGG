    ...
    <?php else: ?>
            <div class="box text-center">
                <form method="post">
                    ...
                    <input type="text" value="<?=old('nama') ?? htmlspecialchars($fetch_data->nama) ?>" name="nama" placeholder="Masukkan Nama" class="form-control<?=$error && !empty($error_val['nama']) ?' is-invalid' : ''?>"><br/>
                    ...
                    <button class="btn btn-primary" name="submit" value="ya" id="tambah">Edit Admin</button>
                </form>
            </div>
    <?php endif ?>
